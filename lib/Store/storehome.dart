...
Widget sourceInfo(ItemModel model, BuildContext context,
  ...
  var num = ((model.price - model.discount) / (model.price)) * 100;
  return InkWell(
    onTap: () {
      Route route =
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Container(
                        decoration: BoxDecoration(
                            shape: BoxShape.rectangle, color: Colors.teal[400]),
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  (model.price).floorToDouble().toString(),
                                  style: TextStyle(
                                    fontSize: 16.0,
                                    color: Colors.grey,
                                    decoration: TextDecoration.lineThrough,
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  model.discount.floorToDouble().toString(),
                                  style: TextStyle(
                                    fontSize: 16.0,
                                    color: Colors.red,
                                  ),
