...
class _UploadPageState extends State<UploadPage>
  ...
  TextEditingController _discountTextEditingController = TextEditingController();
          ...
          ListTile(
            ...
            title: Container(
              ...
              child: TextField(
                ...
                controller: _discountTextEditingController,
                decoration: InputDecoration(
                  hintText: "Discount",
                  hintStyle: TextStyle(color: Colors.teal[900]),
                  border: InputBorder.none,
  ...
  saveItemInfo(String downloadUrl) {
    ...
    itemsRef.document(productId).setData({
      ...
      "discount": int.parse(_discountTextEditingController.text),
